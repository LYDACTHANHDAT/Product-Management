...
public class GioiThieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/duan1/Logo-big.jpg"))); // NOI18N

        jTextPane1.setEditable(false);
        jTextPane1.setBorder(null);
        jTextPane1.setText("Product Management là dự án quản lý sản phẩm. Mục tiêu chính là giúp cho các doanh nghiệp quản lý hàng hóa, sản phẩm của mình, tránh những sai sót không đáng có.\n\nYêu cầu về môi trường\n1. Hệ điều hành bất kỳ\n2. JDK 1.8 trở lên\n3. SQL Server 2008 trở lên");
