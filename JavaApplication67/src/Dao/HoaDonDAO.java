...
public class HoaDonDAO {
    ...
    public void update(HoaDon model){
        String sql="UPDATE HoaDon SET MaNV=?, NgayLapHD=?, TongTien=?, GhiChu=? WHERE MaHD=?";
        JdbcHelper.executeUpdate(sql, model.getMaNV(),model.getNgayLap(),model.getTongTien(),model.getGhiChu(),model.getMaHD()); 
  }
